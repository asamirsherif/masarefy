...
return [
    ...
    'heading' => [
        ...
        'intro' => 'هنا تقوم بمتابعة الميزانية الخاصة بك و تحديد أولويات الإنفاق',

    ],

    'info-box' => [
        'overbudget' => 'لقد انفقت %s و هو بنسبة %s%% أكثر من الميزانية الشهرية ، لا يوجد مال إضافي لإنفاقه :(',
        'underbudget' => 'لقد انفقت %s%% من الميزانية الشهرية المتوقعة. مازال لديك %s%% .',
